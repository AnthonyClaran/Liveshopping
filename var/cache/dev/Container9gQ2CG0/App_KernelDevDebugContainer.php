...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\API\\CategoryApiController' => 'getCategoryApiControllerService',
            'App\\Controller\\API\\ItemApiController' => 'getItemApiControllerService',
            'App\\Controller\\API\\StockControllerApi' => 'getStockControllerApiService',
            ...
            'App\\Controller\\LiveApiController' => 'getLiveApiControllerService',
            'App\\Controller\\LoginController' => 'getLoginControllerService',
            'App\\Controller\\ProfilAdminController' => 'getProfilAdminControllerService',
            'App\\Controller\\ProfilClientController' => 'getProfilClientControllerService',
            'App\\Controller\\ProfilController' => 'getProfilControllerService',
            'App\\Controller\\PromotionApiController' => 'getPromotionApiControllerService',
            'App\\Controller\\PromotionController' => 'getPromotionControllerService',
            'App\\Controller\\StockController' => 'getStockControllerService',
            'App\\Service\\CountryService' => 'getCountryServiceService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\API\\CategoryApiController', 'App\\Controller\\API\\ItemApiController', 'App\\Controller\\API\\StockControllerApi', 'App\\Controller\\API\\UserApiController', 'App\\Controller\\AdminController', 'App\\Controller\\ClassementController', 'App\\Controller\\ClientController', 'App\\Controller\\HistoriqueController', 'App\\Controller\\InscriptionController', 'App\\Controller\\LiveApiController', 'App\\Controller\\LoginController', 'App\\Controller\\ProfilAdminController', 'App\\Controller\\ProfilClientController', 'App\\Controller\\ProfilController', 'App\\Controller\\PromotionApiController', 'App\\Controller\\PromotionController', 'App\\Controller\\StockController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    /**
     * Gets the private '.service_locator.qk2gHME' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_Qk2gHMEService($container)
    {
        return $container->privates['.service_locator.qk2gHME'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\BagDetailsRepository' => ['privates', 'App\\Repository\\BagDetailsRepository', 'getBagDetailsRepositoryService', true],
            'App\\Repository\\BagRepository' => ['privates', 'App\\Repository\\BagRepository', 'getBagRepositoryService', true],
            ...
            'App\\Repository\\ExportTempRepository' => ['privates', 'App\\Repository\\ExportTempRepository', 'getExportTempRepositoryService', true],
            'App\\Repository\\FavoriteDetailsRepository' => ['privates', 'App\\Repository\\FavoriteDetailsRepository', 'getFavoriteDetailsRepositoryService', true],
            'App\\Repository\\FavoritesRepository' => ['privates', 'App\\Repository\\FavoritesRepository', 'getFavoritesRepositoryService', true],
            'App\\Repository\\FollowSellerRepository' => ['privates', 'App\\Repository\\FollowSellerRepository', 'getFollowSellerRepositoryService', true],
            'App\\Repository\\GoalsRepository' => ['privates', 'App\\Repository\\GoalsRepository', 'getGoalsRepositoryService', true],
            ...
            'App\\Repository\\ItemSizeRepository' => ['privates', 'App\\Repository\\ItemSizeRepository', 'getItemSizeRepositoryService', true],
            'App\\Repository\\ItemsStockRepository' => ['privates', 'App\\Repository\\ItemsStockRepository', 'getItemsStockRepositoryService', true],
            'App\\Repository\\LiaisonNotificationRepository' => ['privates', 'App\\Repository\\LiaisonNotificationRepository', 'getLiaisonNotificationRepositoryService', true],
            'App\\Repository\\LiveDetailsRepository' => ['privates', 'App\\Repository\\LiveDetailsRepository', 'getLiveDetailsRepositoryService', true],
            'App\\Repository\\LiveRepository' => ['privates', 'App\\Repository\\LiveRepository', 'getLiveRepositoryService', true],
            ...
            'App\\Repository\\PriceItemsRepository' => ['privates', 'App\\Repository\\PriceItemsRepository', 'getPriceItemsRepositoryService', true],
            'App\\Repository\\PromotionRepository' => ['privates', 'App\\Repository\\PromotionRepository', 'getPromotionRepositoryService', true],
            'App\\Repository\\SaleRepository' => ['privates', 'App\\Repository\\SaleRepository', 'getSaleRepositoryService', true],
            'App\\Repository\\SizeRepository' => ['privates', 'App\\Repository\\SizeRepository', 'getSizeRepositoryService', true],
            'App\\Repository\\StateCommandeRepository' => ['privates', 'App\\Repository\\StateCommandeRepository', 'getStateCommandeRepositoryService', true],
            'App\\Repository\\UsersRepository' => ['privates', 'App\\Repository\\UsersRepository', 'getUsersRepositoryService', true],
        ], [
            'App\\Repository\\BagDetailsRepository' => '?',
            'App\\Repository\\BagRepository' => '?',
            'App\\Repository\\CategoryRepository' => '?',
            'App\\Repository\\CommandeDetailsRepository' => '?',
            'App\\Repository\\CommandeRepository' => '?',
            'App\\Repository\\ExportTempRepository' => '?',
            'App\\Repository\\FavoriteDetailsRepository' => '?',
            'App\\Repository\\FavoritesRepository' => '?',
            'App\\Repository\\FollowSellerRepository' => '?',
            'App\\Repository\\GoalsRepository' => '?',
            'App\\Repository\\HistoryRepository' => '?',
            'App\\Repository\\ItemRepository' => '?',
            'App\\Repository\\ItemSizeRepository' => '?',
            'App\\Repository\\ItemsStockRepository' => '?',
            'App\\Repository\\LiaisonNotificationRepository' => '?',
            'App\\Repository\\LiveDetailsRepository' => '?',
            'App\\Repository\\LiveRepository' => '?',
            'App\\Repository\\NotificationRepository' => '?',
            'App\\Repository\\NotificationTypeRepository' => '?',
            'App\\Repository\\PriceItemsRepository' => '?',
            'App\\Repository\\PromotionRepository' => '?',
            'App\\Repository\\SaleRepository' => '?',
            'App\\Repository\\SizeRepository' => '?',
            'App\\Repository\\StateCommandeRepository' => '?',
    ...
    {
        $a = ($container->privates['.service_locator.qk2gHME'] ?? self::get_ServiceLocator_Qk2gHMEService($container));
