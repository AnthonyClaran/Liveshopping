 ...
 */
class getSaleRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/SaleRepository.php';

        return $container->privates['App\\Repository\\SaleRepository'] = new \App\Repository\SaleRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
