...
/* components/navbarClient.html.twig */
class __TwigTemplate_657e3d3cd61d7c92a8f41899da4a9c9f extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "components/navbarClient.html.twig"));
...
<nav class=\"navbar\">
    ...
    <div class=\"right-group\">
        <input class=\"search-bar\" type=\"text\" placeholder=\"Recherche...\" data-i18n-placeholder=\"search\">
        <div class=\"icons\">
            <span class=\"icon\">
                <!-- Loupe -->
...
<style>
    .navbar {
        ...
        left: 0;
        width: 100%;
        z-index: 2000; /* Toujours au-dessus du contenu */
    }
    .nav-links {
        display: flex;
        gap: 30px;
    ...
    body.dark-theme .logo-shop { color: #fff; }

    body.dark-theme .search-bar { background: #2a2a2a; color: #eee; border: 1px solid #444; }

    body.dark-theme .icons svg {
        stroke: #567AF4;
    }

    body.dark-theme .side-menu { background: #2b2b2b; box-shadow: -4px 0 8px rgba(0,0,0,0.3); }

    body.dark-theme .username,
    body.dark-theme .theme-toggle-container { color: #fff; }

    body.dark-theme .user-menu a {
        color: #567AF4;
    }

    body.dark-theme .user-menu a:hover { color: #fff; }
</style>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Utiliser une clé globale pour la persistance du thème sur tout le site
        const userThemeKey = 'site_theme';
...
";
    ...
    {
        return "components/navbarClient.html.twig";
    }
...
<nav class=\"navbar\">
    <div class=\"nav-links\" id=\"navLinks\">
        <a href=\"{{ path('app_client') }}\" data-i18n=\"home\">Home</a>
        <a href=\"#\" data-i18n=\"favorites\">Favoris List</a>
        <a href=\"#\" data-i18n=\"cart\">Cart</a>
    </div>
...
", "components/navbarClient.html.twig", "/home/tikiz/Asa/LiveShopping-V2-dev/desktopLive/templates/components/navbarClient.html.twig");
    }
}
